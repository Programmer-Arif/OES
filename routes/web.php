...
// Route::get('/test', function () {
//     // Explicitly setting the PayPal configuration
//     Config::set('paypal', [
//         'mode'    => 'sandbox', // Change to 'live' if needed
//         'sandbox' => [
//             'client_id'     => env('PAYPAL_SANDBOX_CLIENT_ID', 'your-client-id'),
//             'client_secret' => env('PAYPAL_SANDBOX_CLIENT_SECRET', 'your-client-secret'),
...
//     // Instantiate PayPalClient
//     $provider = new PayPalClient;

//     // Set API credentials before making any requests
